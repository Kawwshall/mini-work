...
public class RsetiListDto {
    ...
    // Constructor
    public RsetiListDto(UUID uuid, String extId, String name, String email, String contactNo, String districtName,
                        String address, String directorName, String directorContactNo, Integer stateId, UUID bankId, int courseCount) {
        this.uuid = uuid;
        this.extId = extId;
        this.name = name;
        this.email = email;
